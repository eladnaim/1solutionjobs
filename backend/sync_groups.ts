...
const CITIES_MAPPING: Record<string, string[]> = {
    'south': ['באר שבע', 'אשקלון', 'אשדוד', 'נתיבות', 'שדרות', 'אילת', 'דרום', 'קרית גת', 'דימונה'],
    'north': ['חיפה', 'קריות', 'נהריה', 'עכו', 'צפון', 'טבריה', 'כרמיאל', 'גליל', 'עפולה', 'נצרת'],
    'center': ['תל אביב', 'רמת גן', 'גבעתיים', 'פתח תקווה', 'ראשון לציון', 'חולון', 'בת ים', 'מרכז', 'רעננה', 'כפר סבא', 'הרצליה', 'השרון', 'נתניה', 'הוד השרון', 'מודיעין'],
    'jerusalem': ['ירושלים', 'מבשרת', 'מעלה אדומים', 'בית שמש'],
    'shfela': ['רחובות', 'נס ציונה', 'לוד', 'רמלה', 'גדרה', 'יבנה']
};
