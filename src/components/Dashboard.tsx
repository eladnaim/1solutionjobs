                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mt-1 items-center">
                            ...
                            <div className="flex -space-x-2 mr-4">
                                ...
                                <div title="Facebook Service" className={`w-10 h-10 rounded-full border-4 border-white flex items-center justify-center shadow-lg transition-all ${isFacebookConnected ? 'bg-[#1877F2] text-white' : 'bg-slate-200 text-slate-400'}`}>
                                    <Facebook size={14} />
                                </div>
